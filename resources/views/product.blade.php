                    ...
                    <div class="row no-gutters align-items-center ">
                        ...
                        <div class="col-lg-8 col-md-7">
                            <div class="slider-product-content">
                                ...
                                <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s" style="text-align: justify"> Solutions for the home, office and contract. Transform a space into a unique environment. For over thirty years, we have been offering the most interesting interior design pieces. Tailor Made Furniture. Unique Pieces. Interior Design Projects.</p>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="{{ asset('product_picture') }}/{{ $product->image_name ?? '' }}" alt="Product" style="height: 320px"></a>
                                            ...
                                            <div class="product-item-content text-center mt-30">
                                                ...
                                                {{--  Add To cart button in the js/component/ExampleComponent  --}}
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-30">
                        ...
                        <p style="text-align: justify">There’s a variety of different types of furniture that can be used in a home. When choosing furniture for your bedroom, living room, or any other area of the home, it’s important to consider your personal style and what suits your needs.</p>
                    </div> <!-- section title -->
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="col-md-6 col-sm-8">
                                <div class="single-services text-center">
                                    ...
                                    <div class="services-content mt-20">
                                        ...
                                        <p style="text-align: justify">In a living space, many people want a couch for watching TV or relaxing. When choosing a couch, it’s important to think about how and where you will be using it.</p>
                                    </div>
                                </div> <!-- single services -->
                                ...
                                <div class="single-services text-center mt-30">
                                    ...
                                    <div class="services-content mt-20">
                                        ...
                                        <p style="text-align: justify">When choosing furniture for your bedroom, living room, or any other area of the home, it’s important to consider your personal style and what suits your needs.</p>
                                    </div>
                                </div> <!-- single services -->
                            </div>
                            <div class="col-md-6 col-sm-8">
                                <div class="single-services text-center mt-30">
                                    ...
                                    <div class="services-content mt-20">
                                        ...
                                        <p>When choosing furniture for your bedroom, living room, or any other area of the home, it’s important to consider your personal style and what suits your needs.</p>
                                    </div>
                                </div> <!-- single services -->
                    ...
                    <div class="testimonial-content">
                        <div class="testimonial-active">
                            <div class="single-testimonial">
                                ...
                                <p class="mb-30" style="text-align: justify">When choosing furniture for your bedroom, living room, or any other area of the home, it’s important to consider your personal style and what suits your needs.</p>
                                <h6 class="title">Roma De Suza</h6>
                                <span>- CEO, Tesla</span>
                            </div> <!-- single testimonial -->
                            <div class="single-testimonial">
                                <i class="lni-quotation"></i>
                                <p class="mb-30" style="text-align: justify">In a living space, many people want a couch for watching TV or relaxing. When choosing a couch, it’s important to think about how and where you will be using it.</p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-25">
                        ...
                        <p style="text-align: justify">When choosing furniture for your living room, it’s important to consider your needs and what you’re looking for. Here are a few tips to help you make the right decision.</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="single-info mt-30">
                                        ...
                                        <div class="info-content">
                                            <p>adebayonathaniel79@gmail.com</p>
                                        </div>
                                    </div> <!-- single info -->
                                </li>
                                <li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-5 col-sm-7">
                        <div class="footer-logo mt-40">
                            ...
                            <p class="mt-10" style="text-align: justify">Finding the right Haverty furniture for your home can be a daunting task because there’s such an amazing selection to choose from, but we’ve got you covered.</p>
